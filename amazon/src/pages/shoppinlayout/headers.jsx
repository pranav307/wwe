...
import UserCartWrapper from "./usercartwraper";
import { shoppingViewHeaderMenuItems } from "../confirmSchema";
...
function MenuItems() {
  ...
  function handleNavigate(getCurrentMenuItem) {
    ...
    location.pathname.includes("/shopping") && currentFilter !== null
      ? setSearchParams(
