...
import {
  ...
  fetchProductDetails,
} from "@/store/shopproducts";
import { useEffect, useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import { useSearchParams } from "react-router-dom";
import ProductFilter from "./filters";
import { sortOptions } from "../confirmSchema";
...
function ShoppingListing() {
  ...
  const { productListshop, productDetails } = useSelector(
  ...
  console.log(productListshop, "productListproductListproductList");
    ...
    <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 p-4 md:p-6">
      ...
      <div className="bg-background w-full rounded-lg shadow-sm">
        <div className="p-4 border-b flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-muted-foreground">
              {productListshop?.length} Products
            </span>
            <DropdownMenu>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
          {productListshop && productListshop.length > 0
            ? productListshop.map((productItem) => (
                <ShoppingproductTile
